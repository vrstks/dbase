...
wxToolBar* wxDBFAppFrame::CreateToolBar()
{
   ...
   static const wxTOOLBARITEM aID[] =
   {
      ...
      { XRCID("edit")      , wxART_HELP_SETTINGS, wxT("Edit")  , wxT("Edit"), wxACCEL_NORMAL, WXK_F2 },
      { wxID_DELETE        , NULL               , NULL         , NULL      , wxACCEL_NORMAL, WXK_DELETE },
      { wxID_SEPARATOR     , NULL               , NULL         , NULL      , 0, 0                  },
      { wxID_PRINT         , NULL               , NULL         , NULL      , wxACCEL_CTRL, 'P' },
      { wxID_PREVIEW       , NULL               , wxT("Preview"), NULL     , wxACCEL_CTRL | wxACCEL_SHIFT, 'P' },
      { wxID_SEPARATOR     , NULL               , NULL         , NULL      , 0, 0                  },
      { XRCID("struct")    , wxART_HELP_SIDE_PANEL, wxT("Structure"), wxT("Modify Structure"), wxACCEL_CTRL, 'M' },
      { XRCID("pack")      , wxART_DEL_BOOKMARK , wxT("Pack")  , wxT("Pack Database"), wxACCEL_CTRL, 'D' },
      { wxID_SEPARATOR     , NULL               , NULL         , NULL      , 0, 0                  },
