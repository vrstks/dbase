...
# ADD LINK32 user32.lib /nologo /subsystem:windows /debug /machine:I386 /out:"..\..\bin/wxdbf-ansi_d.6.exe" /libpath:"$(WXWIN)\lib\vc_dll"
...
# ADD LINK32 gdi32.lib kernel32.lib user32.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib /nologo /subsystem:windows /machine:I386 /out:"..\..\bin/wxdbf-ansi.exe" /libpath:"$(WXWIN)\lib\vc_lib"
