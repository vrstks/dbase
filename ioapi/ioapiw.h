...
extern int    zgets_file (void* stream, const struct zlib_filefunc_def_s* , char   * szDst, int nMax, int* bUnicode);
...
extern int    zgets_fileW(void* stream, const struct zlib_filefunc_defW_s*, wchar_t* szDst, int nMax, int* bUnicode);
